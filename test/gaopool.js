...
//
//        let res = await miner.find_contribution(accounts[0]);
//        console.log("Epoch contribution: " + res[2].valueOf());
//        console.log("Total claimed: " + res[5].valueOf());
//        console.log("Actual: " + res[6].valueOf());
//        console.log("Project balance: " + res[4].valueOf());
//
//
//        // Bte contract balance
//        let bte_balance = await bte_instance.balanceOf(miner.address);
//        let balance = await miner.balanceOf(accounts[0]);
//        let user_balance = await bte_instance.balanceOf(accounts[0]);
//        //console.log(bte_balance.valueOf());
//        //console.log(balance.valueOf());
//        //console.log(user_balance.valueOf());
//
//        // At this point we have accrued almost 100
//        // This is because of rounding error with fixed point math
//        ///let balance = await miner.balanceOf(accounts[0]);
